...
'Bertingkah kaya monyet di ora ng terdekat',
             ...
             let ahhh = await getBuffer(`https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`)
              Dha.sendMessage(from, { image: ahhh, caption: '*Kamu Memilih Tantangan*\n\n'+ Dhadare }, {quoted:m})
              break
                            break
       case 'truth':
       if (!isPremium && global.db.data.users[m.sender].limit < 1) return replyNya(mess.endLimit) // respon ketika limit habis
...
'Apakah kamu pernah melakukan ghosting?',
              ...
              let crot = await getBuffer(`https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`)
              Dha.sendMessage(from, { image: crot, caption: '*Kamu Memilih Kebenaran*\n\n'+ Dhatruth }, {quoted:m})
              break
            case 'tebak': {
